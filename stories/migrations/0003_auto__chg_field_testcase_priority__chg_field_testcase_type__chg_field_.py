...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestCase.priority'
        db.alter_column(u'stories_testcase', 'priority', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TestCase.type'
        db.alter_column(u'stories_testcase', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TestCase.method'
        db.alter_column(u'stories_testcase', 'method', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TestCase.risk'
        db.alter_column(u'stories_testcase', 'risk', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'TestCase.priority'
        db.alter_column(u'stories_testcase', 'priority', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'TestCase.type'
        db.alter_column(u'stories_testcase', 'type', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'TestCase.method'
        db.alter_column(u'stories_testcase', 'method', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'TestCase.risk'
        db.alter_column(u'stories_testcase', 'risk', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))
