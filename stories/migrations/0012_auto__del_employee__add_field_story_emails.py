...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'stories_employee')

        # Adding field 'Story.emails'
        db.add_column(u'stories_story', 'emails',
                      self.gf('multi_email_field.fields.MultiEmailField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Employee'
        db.create_table(u'stories_employee', (
        ...
        db.send_create_signal(u'stories', ['Employee'])

        # Deleting field 'Story.emails'
        db.delete_column(u'stories_story', 'emails')
    ...
    models = {
        ...
        u'stories.story': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'emails': ('multi_email_field.fields.MultiEmailField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'stories.task': {
            'Meta': {'ordering': "['position']", 'object_name': 'Task'},
        ...
        u'stories.taskattachment': {
            'Meta': {'object_name': 'TaskAttachment'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stories.Task']"})
        },
        u'stories.testcase': {
