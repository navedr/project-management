...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.email'
        db.alter_column(u'stories_story', 'email', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Story.email'
        db.alter_column(u'stories_story', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
